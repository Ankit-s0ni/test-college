  ...
  <table className="min-w-full text-sm">
    <thead>
      <tr className="bg-[#1E4BFF] text-white border-black">
        ...
        <th className="px-4 py-4 text-center font-medium" colSpan={4}>Semester Wise</th>
        <th className="px-4 py-4 text-center font-medium">Online</th>
      </tr>
      <tr className="bg-muted/50 border-black">
        <th className="px-4 py-4" />
        <th className="px-4 py-4 font-medium" colSpan={2}>Per Semester</th>
        <th className="px-4 py-4 font-medium" colSpan={2}>Total Fees</th>
        <th className="px-4 py-4" />
      </tr>
    </thead>
    <tbody className="[&>tr:not(:last-child)]:border-b [&>tr:not(:last-child)]:border-border">
      {data.courses.map((c) => (
        <tr key={c.name} className='border-black'>
          ...
          <td className="px-4 py-4 text-center font-medium border-black" colSpan={2}>{c.perSem}</td>
          <td className="px-4 py-4 text-center font-medium border-black" colSpan={2}>{c.total}</td>
