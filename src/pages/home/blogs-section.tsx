    ...
    <div id="blog" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">We explore how all the institutions are pushing the boundaries of science and technologies.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="bg-card rounded-lg overflow-hidden border border-border hover:shadow-lg transition-shadow">
                ...
                <Image
                  src={'https://images.unsplash.com/photo-1545048702-79362596cdc9?q=80&w=1400&auto=format&fit=crop'}
                  alt={`blog`}
                ...
                />
                <div className="p-6">
                  <h3 className="font-semibold mb-2">Mastering Online Exams In India; A comprehensive...</h3>
