        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <div className="col-span-2">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Connect with Lorem ipsum and start your career transformation. We enable everyone to create professional videos without experience or staff skills.
              </p>
              <p className="text-gray-400 text-sm mb-4">
                Using AI, we&apos;re radically changing the process of content creation, making it scalable and affordable while maintaining high quality.
              </p>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-blue-600 rounded-full"></div>
                <div>
                  <p className="text-sm font-medium">Synthesis Ltd, Synthesis, Kent House,</p>
                  <p className="text-sm text-gray-400">14-17 Market Place, London, W1W 8AJ, United Kingdom</p>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-gray-400">© 2024 product space Limited. All rights reserved.</p>
