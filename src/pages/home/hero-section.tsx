    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            <p className="text-sm text-brand-primary font-medium mb-4">We Simplify Everything For You</p>
          ...
          <div className="relative">
            <Image className="absolute top-0 left-0" src={HeroImage} alt="hero image" width={500} height={500}  />
